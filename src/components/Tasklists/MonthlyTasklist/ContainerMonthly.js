...
export const Container = ({ tasks, setTasks, strikeTask, deleteTask, addTask, filterPriority, filterEffort, filters, updateTaskText, changeTaskType, updateTaskTypeEvent, updateTaskDeadlineEvent, changeTaskProgress, updateTaskProgressEvent, subtasksBtnState, shownSubtasksState, showSubtasks, addSubtask }) => {
