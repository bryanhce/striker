...
function TableMonthly({ tasks, setTasks, strikeTask, deleteTask, filterPriority, filterEffort, filters, updateTaskText, changeTaskType, updateTaskTypeEvent, changeTaskProgress, updateTaskProgressEvent, updateTaskDeadlineEvent, subtasksBtnState, shownSubtasksState, showSubtasks, addSubtask }) {
    ...
    const deadlineOnFocus = (id) => {
        ...
        taskDeadline.value = task.deadline.substring(6)+"-"+task.deadline.substring(3, 5)+"-"+task.deadline.substring(0, 2);
            ...
            <table>
                <thead>
                    <tr className="tableHeader">
                        ...
                        <th className="deadlineHeader filterableHeader" onClick={filterPriority}>
                            <div className="headerContainer">
                        ...
                        <th className="progressHeader filterableHeader" onClick={filterEffort}>
                            <div className="headerContainer">
                                ...
                                <div className="taskTextContainer">
                                    ...
                                    <div className="subtaskBtnContainers">
                                        ...
                                        {subtasksBtnState[tasks.indexOf(task)]
                                            ...
                                            : <RightOutlined className={task.hasChildren ? "subtaskBtn" : "subtaskBtn hidden"} onClick={() => showSubtasks(task.id)}/>}
                                    </div>
                                </div>
                            </td>
